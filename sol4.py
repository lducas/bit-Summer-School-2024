...
def fincke_pohst_enumeration(B, t, r):
    ...
    :param t: A NumPy array representing the target vector to approximate with a lattice point.
    :type t: numpy.ndarray
    :param r: An integer or float representing the distance `r`.
    :type r: int or float

    :return: A generator yielding all lattice vectors within the specified distance from `t`.
    :rtype: numpy.ndarray
    """
    ...
    for s in sub_results:
        ...
        # Remaining radius along b1
        ro = np.sqrt(r**2 - np.linalg.norm(s - t)**2)

        # Enumerate multiples along b1
