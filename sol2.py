...
from sol1 import simple_rounding, orth_proj, in_lattice, Gram_Schmidt_orth, nearest_plane
...
def fincke_pohst_enumeration(B, t, r):
    ...
    for s in sub_results:
        ...
        ro = np.sqrt(r**2 - np.linalg.norm(s)**2)
        ...
        if res:
            results.extend(fincke_pohst_1d_enumeration(b1, x, t, ro))
